...
test("formats the extended Back to School dates in both languages", () => {
  const event = { startAt: "2026-09-14T09:00:00+03:00", endAt: "2026-10-02T18:00:00+03:00" };
  assert.equal(formatEventDate(event, "en"), "14 September – 2 October 2026");
  assert.equal(formatEventDate(event, "ro"), "14 septembrie – 2 octombrie 2026");
});
