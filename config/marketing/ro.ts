export const marketingContent = {
    ...
    tabs: [
      {
        ...
        points: [
          "Editor Monaco multi-limbaj",
          "Structură de proiect și GitHub",
          "Run și terminal integrate",
        ],
      },
      {
        key: "learn",
      ...
      },
      {
        ...
        points: [
          "Privire de ansamblu asupra săptămânii",
          "Teme și deadline-uri viitoare",
          "Progres în roadmap",
        ],
      },
      {
        ...
        points: [
          "Program săptămânal",
          "Task-uri și sesiuni de studiu",
          "Deadline-uri și stări de completare",
        ],
      },
      {
        key: "notes",
        ...
        points: [
          "Foldere pentru notițe",
          "Text formatat și cod",
          "Materiale de studiu partajabile",
        ],
      },
      {
        key: "whiteboard",
        ...
        points: [
          "Canvas liber",
          "Notițe și conexiuni",
          "Planificare vizuală a soluției",
        ],
      },
      {
        key: "graphs",
        ...
        points: [
          "Noduri și muchii interactive",
          "Proprietăți ale grafului",
          "Parcurgere vizuală",
        ],
      },
      {
        ...
        points: [
          "Creare sau înscriere prin cod de invitație",
          "Teme, resurse și deadline-uri",
          "Număr de elevi și progres mediu",
        ],
      },
      {
        key: "problems",
        ...
        points: [
          "Dificultate și enunțuri localizate",
          "Runner și rezultate integrate",
          "Istoric de submisii și cel mai bun scor",
        ],
      },
      {
        ...
        points: [
          "Elevi și clase active",
          "Progres și număr de teme",
          "Deadline-uri și activitate recentă",
        ],
      },
      {
        key: "students",
        ...
        points: [
          "Listă de elevi din toate clasele",
          "Progres individual",
          "Acces direct la elev",
        ],
      },
      {
        key: "assignments",
        ...
        points: [
          "Teme viitoare, restante sau fără deadline",
          "Deadline-uri și contextul clasei",
          "Număr de soluții și progres",
        ],
      },
      {
        key: "calendar",
        ...
        points: [
          "Program lunar pentru clase",
          "Deadline-uri și ore",
          "Acces direct la activități",
        ],
      },
      {
        key: "analytics",
        ...
        points: [
          "Progres general și pe clase",
          "Elevi peste sau sub praguri",
          "Listă pentru intervenții",
        ],
      },
      {
        ...
        points: [
          "Daily challenge și streak",
          "Puncte reward",
          "Progres la lecții și probleme",
        ],
      },
      {
        key: "search",
        ...
        points: [
          "Căutare unificată",
          "Filtre pe tipuri de rezultate",
          "Acces direct la rezultate",
        ],
      },
      {
        key: "collaboration",
        ...
        points: [
          "Sincronizare live pentru cod și proiect",
          "Prezența participanților",
          "Linkuri de sesiune și invitații",
        ],
      },
      {
        key: "groups",
        ...
        points: [
          ...
          "Canale, mențiuni și mesaje fixate",
          "Invitații, atașamente și roluri",
        ],
      },
      {
        key: "rewards",
        ...
        points: [
          "Sold separat de puncte reward",
          "Rame, decorații, fundaluri și titluri",
          "Inventar și obiecte echipate pe profil",
        ],
      },
      {
        key: "competitions",
        ...
        points: [
          "Seturi de probleme cronometrate",
          "Submisii salvate și cel mai bun scor",
          "Clasamente live și etape de concurs",
        ],
      },
      {
        key: "leaderboard",
        ...
        points: [
          "Clasament al comunității",
          "Puncte acumulate",
          "Etape de progres vizibile",
        ],
      },
      {
        key: "feed",
      ...
      },
      {
        ...
        points: [
          "Referință structurată a limbajului",
          "Exemple de sintaxă",
      ...
      },
      {
        ...
        points: [
          "Exemple după dificultate",
          "Mai multe subiecte de programare",
          "Deschidere directă în editor",
        ],
      },
    ],
  },
  ...
  developmentSpotlight: {
    ...
    portalNote:
      "O pagină dedicată clientului păstrează update-urile, fișierele, aprobările și deciziile într-un singur loc.",
    steps: [
      {
        title: "Povestim despre idee",
        description:
          "Începem cu o discuție gratuită de 30–45 de minute despre idee, public, obiectiv, buget și termen. Pleci cu un pas următor mai clar, indiferent dacă lucrăm împreună sau nu.",
        update: "Obiective, constrângeri și pașii următori",
        details: [
          "Obiective și public",
          "Constrângeri și termen",
          "Prime observații de produs",
        ],
      },
      {
        title: "Stabilim planul",
        description:
          "Transformăm discuția într-un scope clar: livrabile, ce rămâne în afara proiectului, etape, durată estimată și cost. Totul este scris înainte să începem.",
      ...
      },
      {
        ...
        description:
          "După aprobarea ofertei și semnarea contractului, stabilim experiența, proiectăm interfața și dezvoltăm în etape ușor de verificat, cu update-uri și feedback regulate.",
        update: "Review-uri de design și development în curs",
        details: [
          "Kickoff și conținut",
          "UX, UI și prototip",
          "Development și review-uri",
        ],
      },
      {
        title: "Lansăm și continuăm",
        description:
          "Testăm produsul pe mai multe dispozitive, pregătim lansarea și predăm documentația și accesul. Apoi stabilim împreună suportul potrivit pentru ce urmează.",
        update: "QA, lansare și predare pregătite",
        details: [
          "QA și aprobare finală",
          "Lansare și predare",
          "Suport ulterior",
        ],
      },
