        ...
        <Reveal className="relative isolate overflow-hidden rounded-[20px] border bg-[#0d0e10] px-6 py-14 text-white sm:px-10 sm:py-20 lg:px-16">
          ...
          <div className="relative z-10 mt-4 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
              <Button size="lg" variant="secondary" asChild><Link href={links.platform}>{content.primary}<ArrowUpRight /></Link></Button>
              <Button size="lg" variant="outline" className="border-white/20 bg-transparent text-white hover:bg-white/10 hover:text-white" asChild><Link href={links.contact}>{content.secondary}</Link></Button>
            </div>
          </div>
        </Reveal>
      </div>
